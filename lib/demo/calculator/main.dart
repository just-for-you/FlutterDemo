          ...
          child: Column(
            children: <Widget>[
              Expanded( //结果显示层
                ...
                flex: 2,
                child: FractionallySizedBox( //百分比布局，设置维度比例 而不是固定的px
                  widthFactor: 1.0,//宽度因子 子组件的宽度等于FractionallySizedBox组件的约束的最大宽度乘以widthFractor，null时组件的宽度约束会原封不动的传递给子组件
                  heightFactor: 1.0,//高度因子 规则同上
                  child: Container(
                  ...
                  child: FractionallySizedBox(
                      ...
                      child: Container(
                        ...
                        child: ListView(
                            ...
                            reverse: true, //是否倒序显示 默认正序 false  倒序true
                            // 高级用法
